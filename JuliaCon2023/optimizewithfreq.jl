#= Omit any reference to complex pulses for the sake of simplicity. =#

import JuliaCon2023 as JOB
import JuliaCon2023: _!, Float
...
pulse = CtrlVQE.UniformWindowed(CtrlVQE.Signals.Constant(0.0), _!.setup.T, _!.setup.W)
...
μR = zeros(L); μR[Ω] .= +_!.setup.ΩMAX
μL = zeros(L); μL[Ω] .= -_!.setup.ΩMAX
